...
mod tests {
    ...
    fn test_get_pos_multi_line() {
        ...
        let mut tok = Tokenizer::new(input, cb);
        tok.tokenize();
        // After tokenizing, newlines are tracked
        // "line1\n" has newline at index 5
        // "line2\n" has newline at index 11
        let pos = tok.get_pos(6); // 'l' of "line2"
        assert_eq!(pos.line, 2);
        assert_eq!(pos.column, 1);

        let pos = tok.get_pos(12); // 'l' of "line3"
    ...
    fn test_shorthand_bind() {
        ...
        // : shorthand emits DirName for the prefix
    ...
    fn test_comment() {
        ...
        // After `<!--`, section_start points to index 4 (the space)
